<div>
  <div
    ...
    data-widget_id-pc="G7ZAB2oW"
    data-widget_id-mo="1XDPzZXe"
    data-widget_id="G7ZAB2oW"
  ></div>

  <div
    id="dablewidget_GlGJyG7x_wXQODA7A"
    data-widget_id-pc="GlGJyG7x"
    data-widget_id-mo="wXQODA7A"
    data-widget_id="GlGJyG7x"
  ></div>

  <div
    id="dablewidget_QXebqEoe_Gok6QnXv"
    data-widget_id-pc="QXebqEoe"
    data-widget_id-mo="Gok6QnXv"
    data-widget_id="QXebqEoe"
  ></div>

  <div
    id="dablewidget_jobZG4oW_zlvqbL78"
    data-widget_id-pc="jobZG4oW"
    data-widget_id-mo="zlvqbL78"
    data-widget_id="jobZG4oW"
  ></div>

  <div
    id="dablewidget_plqWKWoO_klrpe0om"
    data-widget_id-pc="plqWKWoO"
    data-widget_id-mo="klrpe0om"
    data-widget_id="plqWKWoO"
  ></div>
</div>;
...
<div className="hidden mb-14 md:block border border-secondary-medium rounded-lg rounded-br-6xl shadow-md bg-white">
  ...
  <ul className="p-4 flex flex-col space-y-2">
    ...
    <li className="-indent-sm pl-7">
      <span className="inline-block bg-primary-dark rounded-sm mr-2 p-1"></span>
      <a href="#" className="text-gray-800 hover:text-gray-500">
        甲狀腺結節好發女性，健檢發現不用理會？醫師：也有5年後結節變癌症 [AD]
      </a>
    </li>
    <li className="-indent-sm pl-7">
      <span className="inline-block bg-primary-dark rounded-sm mr-2 p-1"></span>
