...
export default function register() {
  return (
    <Layout siteTitle="幸福熟齡 - 會員註冊">
      ...
      {/* <!-- main section--> */}
      <div>
        <div className="max-w-screen-2xl mx-auto px-4 lg:px-2 flex flex-col justify-center items-center md:py-10 space-y-14">
          {/* <!-- register --> */}
          ...
          <div className="register_steps w-full md:w-1/2 flex justify-between relative px-5 md:px-0">
            <div className="step_one flex flex-col items-center">
              ...
              <p className="absolute -bottom-5 text-sm font-medium text-gray-700 whitespace-nowrap">
                輸入基本資料
              </p>
            </div>
            ...
            <div className="step_two flex flex-col items-center relative">
              <div className="flex items-center justify-center h-16 w-16 rounded-md bg-primary-light mb-2">
                <svg
                  ...
                  width="25"
                  height="25"
                  viewBox="0 0 23.88 18.99"
                >
                  <g
                    id="Group_406"
                    data-name="Group 406"
                    transform="translate(0.696 0.5)"
                  >
                    <g id="Icon_feather-mail" data-name="Icon feather-mail">
                      <path
                        id="Path_4143"
                        data-name="Path 4143"
                        d="M5.249,6h17.99a2.255,2.255,0,0,1,2.249,2.249V21.741a2.255,2.255,0,0,1-2.249,2.249H5.249A2.255,2.255,0,0,1,3,21.741V8.249A2.255,2.255,0,0,1,5.249,6Z"
                      ...
                      <path
                        id="Path_4144"
                        data-name="Path 4144"
                        d="M25.488,9,14.244,16.871,3,9"
                        transform="translate(-3 -6.751)"
                        fill="none"
                        stroke="#fff"
                        strokeLinecap="round"
                        strokeLinejoin="round"
              ...
              <p className="absolute -bottom-5 text-sm font-medium text-gray-300 whitespace-nowrap">
                Email 認證
              </p>
            </div>
            <div className="step_prograss h-2 w-full bg-primary-light mt-7"></div>
            <div className="step_three flex flex-col items-center relative">
              <div className="flex items-center justify-center h-16 w-16 rounded-md bg-primary-light mb-2">
                <svg
                  ...
                  width="26.207"
                  height="24.685"
                  viewBox="0 0 26.207 24.685"
                >
                  <g
                    id="Group_407"
                    data-name="Group 407"
                    transform="translate(-764.497 -1369.034)"
                  >
                    <g
                      id="Icon_feather-check-square"
                      data-name="Icon feather-check-square"
                      transform="translate(764.997 1369.534)"
                    >
                      <path
                        id="Path_4145"
                        data-name="Path 4145"
                        d="M13.5,15.211l3.947,3.947L30.605,6"
                        transform="translate(-5.605 -4.684)"
                        fill="none"
                        stroke="#fff"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      ...
                      <path
                        id="Path_4146"
                        data-name="Path 4146"
                        d="M28.184,16.342v9.211a2.632,2.632,0,0,1-2.632,2.632H7.132A2.632,2.632,0,0,1,4.5,25.553V7.132A2.632,2.632,0,0,1,7.132,4.5H21.605"
              ...
              <div className="flex flex-col justify-center items-center space-y-5 py-20 px-3 lg:px-10">
                ...
                >
                  ...
                  <div className="register_agree flex pb-5 border-b border-secondary-medium border-dashed">
                    ...
                    />
                    <span className="ml-2 text-gray-800 text-sm align-middle">
                      加入幸福熟齡網站會員完全免費。勾選表示同意會員條款、
                      註冊幸福熟齡會員，並允許幸福熟齡使用您的會員資訊。
                    </span>
                  </div>
                ...
                <div className="text-sm">
                  ...
                  <Link href="/login">
                    <a
                      className="ml-1 font-medium text-primary-dark hover:text-gray-600 transition-all duration-200 ease-in-out"
                      href="#"
                    >
                      立即登入
                    </a>
