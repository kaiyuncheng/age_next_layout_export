...
const RelatedArticleList = ({ topics, dableIds, isMobile }) => {
    ...
    if (isMobile) {
      if (listItems.length >= 4){
        condition =
          ...
          document.documentElement.offsetHeight - window.innerHeight - 4000;
      }else{
        condition =
          document.documentElement.scrollTop >=
          document.documentElement.offsetHeight - window.innerHeight - 3500;
      }
      ...
      if (listItems.length >= 4) {
        condition =
          document.documentElement.scrollTop >=
          document.documentElement.offsetHeight - window.innerHeight - 2500;
      } else {
        condition =
          document.documentElement.scrollTop >=
