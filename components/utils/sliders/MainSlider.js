                ...
                <div key={i + 1} className="outline-none focus:outline-none">
                  <div className="flex flex-col lg:flex-row lg:h-auto rounded-bl-lg rounded-t-lg rounded-br-5xl shadow-lg bg-white mx-5 overflow-hidden">
                    ...
                    <div className="main_slider_contents relative p-10 w-full lg:w-1/2">
                      ...
                      <p className="text-base md:text-lg mb-10 line-clamp-6">
                        {item.minor_title}
                      </p>

                      <Link href={`/article/${item.url_query}`}>
                        <a className="group absolute z-50 right-0 bottom-0 bg-primary-dark hover:bg-secondary-dark hover:text-primary-dark text-white py-2 px-10 inline-flex items-center justify-center rounded-br-full rounded-tl-full transition-all duration-300 ease-in-out outline-none focus:outline-none">
