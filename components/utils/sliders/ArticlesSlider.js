                  ...
                  <Link href={`/article/${item.article_id}`}>
                    <a className="group relative z-30 rounded-t-lg md:rounded-l-lg md:rounded-t-none block overflow-hidden flex-grow w-full lg:w-1/2 h-72">
                      ...
                      <Image
                        ...
                        src="https://doqvf81n9htmm.cloudfront.net/data/crop_article/112795/shutterstock_1925961107.jpg_1140x855.jpg"
                        alt={item.title}
                        layout="fill"
                      />
                      <span className="absolute left-1 top-1 w-18 h-8 bg-primary-dark pl-3 pt-1 text-white rounded-md rounded-br-5xl">
                      {item.mark_name}
                      </span>
                    </a>
                  </Link>
